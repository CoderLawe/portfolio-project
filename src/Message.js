...
const postMessage = (event) =>{
    ...
    return (
        ...
        <div className=" flex-col py-2 ml-3">
        ...
        <div className=" flex-col ml-3 py-2">
          ...
          <div className=" flex-col py-2">
            <label className="sm:mr-4 mr-2 font-serif">Message:</label>
            <input className="text-black rounded-md h-56 w-52 p-7"type="text" value={message} onChange={(e) => setMessage(e.target.value)}placeholder="Enter your message"/>
          </div>
        ...
        <div className="flex justify-center">
          <Button color="primary" className="-10" variant="outlined" onClick={postMessage}>Submit</Button>
        </div>
